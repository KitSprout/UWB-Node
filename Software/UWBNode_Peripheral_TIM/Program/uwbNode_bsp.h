...
#ifndef __UWBNODE_BSP_H
#define __UWBNODE_BSP_H
...
void UWBN_TIM2_Config( pFunc pTIMx, uint32_t prescaler, uint32_t period );
void UWBN_TIM3_Config( pFunc pTIMx, uint32_t prescaler, uint32_t period );
